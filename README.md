...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-2adqpaq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-2adqpaq.containers.anotherwebservice.com/
...
```
git clone git@github.com:AlaronFV/container-2adqpaq.git
cd container-2adqpaq
```
...
```
docker attach container-2adqpaq
```
